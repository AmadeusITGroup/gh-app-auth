...
- Go to the [Security tab](https://github.com/wherka-ama/gh-app-auth/security) of this repository
...
- CVE will be requested through GitHub's coordination
- CVSS score will be assigned based on impact
- Public disclosure coordinated after fix availability
